# DeployPilot Backend Implementation Specification
...
- Database: PostgreSQL for projects, checks, generated artifacts, deployment evidence.
- Queue: Repo inspection and artifact generation jobs.
...
- workspace_id
- name
- domain: 'deployment package assistance'
- status
- owner_user_id
- metadata_json
- created_at
...
1. Create project for deployment package assistance.
...
- Worker can complete the primary deployment package assistance workflow using sample inputs.
